...
# Agm
echo 'Cloning Agm'
rm -rf hardware/qcom-caf/sm8450/audio/agm && git clone https://github.com/RisingOS-Revived/android_vendor_qcom_opensource_agm -b sixteen hardware/qcom-caf/sm8450/audio/agm

# Pal
echo 'Cloning Pal'
rm -rf hardware/qcom-caf/sm8450/audio/pal && git clone https://github.com/RisingOS-Revived/android_vendor_qcom_opensource_arpal-lx -b sixteen hardware/qcom-caf/sm8450/audio/pal
